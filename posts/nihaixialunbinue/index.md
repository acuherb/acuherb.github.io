...
```mermaid
flowchart TD
    A[开始：遇鼻衄患者] --> B{第一步：问年龄与性别}
    
    B --> C[14岁以下，感冒中]
    C --> D[生理性“衄解”<br>观察，勿塞鼻]
    ...
    G -- 是 --> H[优先考虑：妇女逆经]
    H --> I{辨寒热}
    I --> J[寒凝型：温经散寒<br>（如温经汤+肉桂）]
    I --> K[血热型：凉血下行<br>（如郁金、桂枝汤加郁金）]
    ...
    M -- 热证线索 --> N[喜冷饮、手足热、小便黄、便秘、脉数有力]
    N --> O{伴何症？}
    O --> P[高烧、大汗、大渴<br>→ 阳明经热（白虎汤）]
    O --> Q[便秘、腹胀、潮热<br>→ 阳明腑热（承气汤）]
    O --> R[易怒、口苦、目赤<br>→ 肝经郁热（泻心汤冷服）]
    O --> S[午后潮热、盗汗、舌红少苔<br>→ 阴虚火旺（滋阴）]
    
    M -- 寒证线索 --> T[喜热饮/不渴、手足冷、小便清、便溏、脉无力]
    T --> U[上身热、口干但下身冷、舌淡胖<br>→ 阳虚上浮（四逆汤类）]
    
    U & S & R & Q & P & K & J --> V
    
    subgraph V [第四步：综合诊断]
        W[望眼目：眼白“晕黄”<br>→ 肝肾热未清，需继续清肝]
        X[察禁忌：“衄家”等<br>绝对禁用发汗药]
        Y[急则治标：针灸急救<br>天府、侠白、合谷]
    end
    
    V --> Z[最终处理：<br>结合现代医学检查，排除器质性疾病]
```
