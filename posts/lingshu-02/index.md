...
| 五输 | 穴名 | 部位 | 五行 |
|------|------|------|------|
| 井 | **少商** | 手大指端内侧（桡侧，距指甲角一分） | 木 |
| 荥 | **鱼际** | 手鱼际中后方 | — |
| 输 | **太渊** | 鱼际后一寸陷中（掌后横纹头动脉应手处） | — |
| 经 | **经渠** | 寸口中（桡骨茎突内侧，动脉跳动处） | — |
| 合 | **尺泽** | 肘横纹中央（稍偏桡侧）动脉应手处 | — |

#### 2. 手少阴心经（心包络经代）
| 五输 | 穴名 | 部位 | 五行 |
|------|------|------|------|
| 井 | **中冲** | 手中指之端（距指甲如韭叶） | 木 |
| 荥 | **劳宫** | 掌中央，中指本节后（第三四掌骨间） | — |
| 输 | **大陵** | 掌后腕横纹中央，桡尺骨间 | — |
| 经 | **间使** | 掌后三寸，两筋间凹陷中（有过则至） | — |
| 合 | **曲泽** | 肘横纹肱二头肌腱内侧，屈肘取之 | — |

> **注**：心不受邪，心包络代受其邪。本篇以心包络五输代心经五输（少阴无腧）。后世另立神门等穴为心经五输。

#### 3. 足厥阴肝经
| 五输 | 穴名 | 部位 | 五行 |
|------|------|------|------|
| 井 | **大敦** | 足大趾外侧端，三毛中（距趾甲一分） | 木 |
| 荥 | **行间** | 足大趾、次趾间 | — |
| 输 | **太冲** | 行间上二寸，第二跖骨连接部之前凹陷中 | — |
| 经 | **中封** | 足内踝前一寸半凹陷中（逆则宛，和则通） | — |
| 合 | **曲泉** | 膝内辅骨下，大筋上凹陷中，屈膝取之 | — |

#### 4. 足太阴脾经
| 五输 | 穴名 | 部位 | 五行 |
|------|------|------|------|
| 井 | **隐白** | 足大趾内侧前端 | 木 |
| 荥 | **大都** | 足大趾本节后凹陷中央（赤白肉际） | — |
| 输 | **太白** | 足内侧核骨下方凹陷中 | — |
| 经 | **商丘** | 足内踝前下方凹陷中 | — |
| 合 | **阴陵泉** | 膝下内侧辅骨后下方凹陷中，伸足取之 | — |
...
| 类别 | 穴名 | 部位 | 五行 |
|------|------|------|------|
| 井 | **窍阴** | 第四足趾末端外侧，距趾甲一分 | 金 |
| 荥 | **侠溪** | 足小趾次趾间本节前凹陷中 | — |
| 输 | **临泣** | 侠溪上寸半，本节后凹陷中 | — |
| 原 | **丘墟** | 足外踝前下方凹陷中 | — |
| 经 | **阳辅** | 外踝上四寸，辅骨前，绝骨末端 | — |
| 合 | **阳陵泉** | 膝下一寸，外辅骨头前下方凹陷中，伸足取之 | — |

#### 3. 足阳明胃经
| 类别 | 穴名 | 部位 | 五行 |
|------|------|------|------|
| 井 | **厉兑** | 足大趾内侧次趾前端，距趾甲一分 | 金 |
| 荥 | **内庭** | 次趾外侧本节前凹陷中 | — |
| 输 | **陷谷** | 内庭上二寸，本节后凹陷中 | — |
| 原 | **冲阳** | 足跗上五寸骨间动脉凹陷中，摇足取之 | — |
| 经 | **解溪** | 冲阳后寸半，足跗关节上凹陷中 | — |
| 合 | **足三里** | 膝眼下三寸，胫骨外缘凹陷中 | — |
...
| 类别 | 穴名 | 部位 | 五行 |
|------|------|------|------|
| 井 | **关冲** | 手小指外侧无名指前端，距指甲一分 | 金 |
| 荥 | **液门** | 小指与无名指歧缝间 | — |
| 输 | **中渚** | 本节后两骨间凹陷中 | — |
| 原 | **阳池** | 腕背横纹凹陷中 | — |
| 经 | **支沟** | 腕后三寸，两骨间凹陷中 | — |
| 合 | **天井** | 肘外侧大骨上方凹陷中（肘尖直上寸许），屈肘取 | — |

**三焦下腧穴：**
| 项目 | 内容 |
|------|------|
| **穴名** | 委阳 |
| **部位** | 出腘中外廉，足太阳之前、少阳之后（膝腘外侧凹陷中） |
| **性质** | 足太阳络也，手少阳经也 |
| **入络** | 别入贯腨肠，出于委阳，并太阳之正，入络膀胱，约下焦 |
| **实证** | 闭癃→泻之 |
| **虚证** | 遗溺→补之 |
...
**六腑总数**：五脏五五二十五腧，六腑六六三十六腧。六腑皆出足之三阳，上合于手者也。
...
|------|------|------|----------|
| 正中（一行） | 任脉 | **天突** | 缺盆之中 |
| 二行 | 足阳明胃经 | **人迎** | 任脉侧动脉应手处（结喉两旁） |
| 三行 | 手阳明大肠经 | **扶突** | 人迎外（后一寸五分，曲颊下一寸） |
| 四行 | 手太阳小肠经 | **天窗** | 扶突外（扶突后一寸，下颌角下方） |
| 五行 | 足少阳胆经 | **天容** | 耳下曲颊之后 |
| 六行 | 手少阳三焦经 | **天牖** | 耳后完骨之上方 |
| 七行 | 足太阳膀胱经 | **天柱** | 项大筋之外，发际凹陷中 |
| 八行 | 督脉 | **风府** | 颈中央 |
...
| 穴位 | 取穴要点 |
|------|----------|
| 上关（客主人） | 呿（张口）不能欠（闭口）——张口取穴 |
| 下关 | 欠（闭口）不能呿（张口）——闭口取穴 |
| 犊鼻 | 屈不能伸——屈膝取穴 |
| 两关（内关、外关） | 伸不能屈——伸展手臂取穴 |


### 六、针刺禁忌
- **五里穴**：阴尺动脉所在，五腧之禁也。误刺会使井荥输经合五输穴所内行之脏气衰竭。《灵枢·小针解》："夺阴者死，言取尺之五里五往者也。"
...
| 时令 | 取穴 | 刺法要点 |
|------|------|----------|
| **春** | 络脉、诸荥、大经分肉之间 | 甚者深取之，间者浅取之 |
| **夏** | 诸输、孙络、肌肉皮肤之上 | 浅刺浮表 |
| **秋** | 诸合 | 余如春法（兼取分肉间，浅深依病情） |
| **冬** | 诸井、诸输之分 | 欲深而留之（深刺留针） |

- **原则**：顺应四时气候之序，经气应于四时而不同流注部位，病邪四季居留部位及五脏四时特性。

**特殊病证刺法：**
| 病证 | 体位 | 效果 |
|------|------|------|
| 转筋（痉挛） | 立而取之 | 可令遂已 |
| 痿厥（四肢偏废） | 伸展仰卧而刺之 | 可令立快 |
...
```
本输第二
├── 总纲：刺道需通十二经络终始、五输、六腑合、四时出入
├── 五脏五输穴（各经井荥输经合）
│   ├── 肺：少商→鱼际→太渊→经渠→尺泽
│   ├── 心（心包代）：中冲→劳宫→大陵→间使→曲泽
│   ├── 肝：大敦→行间→太冲→中封→曲泉
│   ├── 脾：隐白→大都→太白→商丘→阴陵泉
│   └── 肾：涌泉→然谷→太溪→复溜→阴谷
├── 六腑五输原穴（各经井荥输原经合）
...
├── 颈项诸穴（以任脉天突为中心分行排列）
│   ├── 人迎、扶突、天窗、天容、天牖、天柱、风府
│   └── 天府、天池（腋部）
├── 针刺体位：上关张口/下关闭口/犊鼻屈膝/内关外关伸臂
├── 禁针：五里穴（夺阴者死）
├── 脏腑相合：肺合大肠、心合小肠、肝合胆、脾合胃、肾合膀胱
│   └── 三焦属膀胱，孤之腑，水道出焉
└── 四时刺法
    ├── 春取络脉荥穴分肉间（浅深依病情）
    ├── 夏取输穴孙络皮肤上（浅）
