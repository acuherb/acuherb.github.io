...
>> 本段是论手足三阳经的脉气，皆自"井穴"而出，并通过"经穴"、"合穴"或"原穴"等，入于颈部及络脉的情况。
...
>> "病气"，在此并非指病邪之气，而是相对于在外的形体表现而言，指在内的受病脏腑的功能表现(亢进或低下)。脏腑功能的亢进(有余)或低下(不足)，都属病态，故称其为"病气"。
...
- **根**：经脉之气的始生之处（多为井穴）。  
- **结**：经脉之气的归结之地（多位于头面胸腹）。  
- **作用**：通过根结理论指导针灸治疗，调节阴阳气血。

### **二、足三阴三阳经的根结与开阖枢**
1. **足三阳经**  
   - **太阳经**：根于至阴（足小趾），结于命门（目）。为“开”，主表；开折（功能失常）则皮肉虚弱，暴病频发，取太阳经补泻。  
   - **阳明经**：根于厉兑（足次趾），结于颡大（鼻咽部）。为“阖”，主里；阖折则气滞痿疾，取阳明经调治。  
   - **少阳经**：根于窍阴（足四趾），结于窗笼（耳中）。为“枢”，主转枢；枢折则骨节弛缓（骨繇），取少阳经调治。  

2. **足三阴经**  
   - **太阴经**：根于隐白（足大趾），结于太仓（中脘）。为“开”，开折则脾失运化（膈洞），取太阴经补泻。  
   - **少阴经**：根于涌泉（足心），结于廉泉（喉）。为“枢”，枢折则血脉瘀结，取少阴经调治。  
   - **厥阴经**：根于大敦（足大趾），结于玉英（膻中）。为“阖”，阖折则气绝善悲，取厥阴经补泻。

### **三、十二经的根、溜、注、入穴位**
列举各经气血运行的四个关键穴位（以足三阳、手三阳为例）：  
- **足太阳**：至阴（根）→京骨（溜）→昆仑（注）→天柱、飞扬（入）。  
- **手阳明**：商阳（根）→合谷（溜）→阳溪（注）→扶突、偏历（入）。  
（其余经脉类似，强调“盛络皆当取之”。）

### **四、脉象与五脏之气**
- **五十营**：气血一昼夜循环50周，供养五脏。脉象代歇提示脏气衰败：  
  - 50动无代：五脏气足；  
  - 不满10动一代：五脏气绝，预后不良。  
...
3. **调阴阳为要**：  
   - 误补实症或泻虚症会导致气血逆乱，甚至死亡。  
   - 上工（高明医者）平气，下工（庸医）绝气，强调审五脏、经络、皮脉虚实再施治。
